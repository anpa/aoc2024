defmodule Day04 do
    ...
    def number_of_xmas(map, y, x) do
        [
            [map[y][x],map[y][x+1],map[y][x+2],map[y][x+3]], # right
            [map[y][x],map[y+1][x+1],map[y+2][x+2],map[y+3][x+3]], #right-bottom
            [map[y][x],map[y+1][x],map[y+2][x],map[y+3][x]], # bottom
            [map[y][x],map[y+1][x-1],map[y+2][x-2],map[y+3][x-3]], #left-bottom
            [map[y][x],map[y][x-1],map[y][x-2],map[y][x-3]], # left
            [map[y][x],map[y-1][x-1],map[y-2][x-2],map[y-3][x-3]], #left-top
            [map[y][x],map[y-1][x],map[y-2][x],map[y-3][x]], #top
            [map[y][x],map[y-1][x+1],map[y-2][x+2],map[y-3][x+3]] #right-top
        ]
        |> Enum.map(fn x -> x
